 ...
 * @return 
  ...
  public Node<E> addFirst(E e) {
    return addBetween(e, header, header.getNext());    // place just after the header
  }
  ...
  public Node<E> addLast(E e) {
    return addBetween(e, trailer.getPrev(), trailer);  // place just before the trailer
  }
